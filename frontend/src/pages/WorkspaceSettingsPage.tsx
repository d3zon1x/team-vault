    ...
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-1">
          Manage workspace details for {workspace.name}
        </p>
      </div>
      ...
      <form
        ...
        className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 space-y-5 mb-8"
      >
        ...
        <div>
          ...
          <input
            ...
            type="text"
            disabled={!canEdit}
            className="w-full px-4 py-2.5 bg-slate-700/50 border border-slate-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-white placeholder-slate-500 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          />
          {errors.name && (
        ...
        {canEdit && (
          <button
            ...
            className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-semibold text-sm hover:shadow-lg hover:shadow-blue-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
